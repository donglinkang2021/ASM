...
predicate=queries/stack_queries/predicate
query_file=queries/stack_queries/all_queries.pkl
sub_plan_file=queries/stack_queries/all_sub_plan_queries_str.pkl
